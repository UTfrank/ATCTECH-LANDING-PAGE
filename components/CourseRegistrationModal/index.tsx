    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="w-10/12 md:w-5/12 h-[90vh]">
                <DialogHeader>
                    <DialogTitle className="text-xl font-bold text-[#040000]" data-aos="fade-down">
                        Course Registration
                    </DialogTitle>
                </DialogHeader>
                <div className="grid gap-4 space-y-4 p-2 h-full overflow-y-scroll scrollbar-hidden">
                    <div className="flex gap-x-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div className="flex flex-col justify-center items-start gap-y-4" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div className="flex flex-col justify-center items-start gap-y-4" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div className="flex gap-x-4" data-aos="fade-up" data-aos-delay="400">
                        <div className="flex flex-col justify-center items-start gap-y-4">
