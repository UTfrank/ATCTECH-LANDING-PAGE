    ...
    return (
        <section className="py-10 w-full font-mulish">
            <div className="container flex flex-col md:flex-row justify-between items-center md:gap-x-10 lg:gap-x-28 gap-y-4">
                <div className="py-[60px] px-10 border text-white rounded-xl flex flex-col gap-y-4 md:gap-y-6 bg-options work_process-bg w-full md:w-[45%] lg:w-[30%]" data-aos="fade-right">
                ...
                <div className="flex-1 grid md:grid-cols-2 gap-x-4 lg:gap-x-[100px] gap-y-7">
                    {work_process.map((item, index) => (
                        <div key={item.id} className="text-[#040000]" data-aos="fade-up" data-aos-delay={100 * index}>
                            <div>
