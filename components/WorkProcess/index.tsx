...
const WorkProcess = () => {
    return (
        <section className="py-10 w-full font-mulish">
            <div className="container flex justify-between items-center gap-x-28">
                <div className="py-[60px] px-10 border text-white rounded-xl flex flex-col gap-y-6 bg-options work_process-bg w-[30%]">
                    <h4 className="text-[36px] leading-10 font-extrabold">Our Working
                        Process - How
                        We Work For Our
                        Customers</h4>
                ...
                <div className="flex-1 grid grid-cols-2 gap-x-[100px] gap-y-7">
                    {work_process.map(item => (
                        <div key={item.id} className="text-[#040000]">
                            ...
                            <h5 className="text-xl font-bold w-7/12">{item.title}</h5>
