        ...
        <section className="mt-14 py-[100px] md:py-[195px] bg-options font-mulish text-white" style={{ backgroundImage: "url(/team_bg.png)" }}>
            <div className="w-10/12 lg:w-9/12 mx-auto">
                <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-y-3 md:gap-y-0 w-full">
                    <div>
                        <h3 className="text-[24px] lg:text-[32px] font-extrabold w-full lg:w-8/12">Our Team</h3>
                        <p className="font-normal text-sm md:w-8/12">Joining a dynamic team doesn’t have to be complicated. ATCTECH CONSULTING LTD is built to empower talent for growth and success.</p>
                    </div>
                    <Button variant="primary" size="md" className="!text-[#040000] !text-[12.5px] !md:text-sm hover:!bg-white px-4 py-4 !w-[205px]">Join Our Team</Button>
                </div>
