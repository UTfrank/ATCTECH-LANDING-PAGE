    ...
    return (
        <div className="w-full font-mulish">
            <div className="container flex flex-col md:flex-row md:gap-x-[60px] py-5 lg:p-5">
                <div className="flex flex-col gap-y-[20px] lg:gap-y-[27px] w-full md:w-5/12" data-aos="fade-right" data-aos-delay="600">
                    ...
                    <div className="w-full flex gap-x-[10px] lg:gap-x-[29px]">
                        <div className="px-4 lg:px-8 py-[33px] lg:py-[54px] rounded-xl bg-[#710000] text-white flex flex-col font-mulish" data-aos="zoom-in" data-aos-delay="300">
                ...
                <div className="flex-1 flex flex-col gap-y-5 lg:gap-y-10 mt-4 md:mt-0" data-aos="fade-left" data-aos-delay="200">
                    ...
                    <ul className="pt-3 lg:pt-7 w-full lg:w-8/12 border-t flex flex-col gap-y-6">
                        {about_details.map((item, index) => (
                            <li key={item.id} className="flex gap-x-[22px]" data-aos="fade-up" data-aos-delay={200 + (index * 100)}>
                    ...
                    <Button variant="secondary" fullWidth={false} size="md" className="w-fit" data-aos="fade-up" data-aos-delay="500">Join our Team</Button>
                </div>
            </div>
        </div>
    )
