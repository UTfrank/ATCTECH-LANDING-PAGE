    ...
    return (
            ...
            <div className="w-10/12 lg:w-9/12 flex flex-col gap-y-10">
                <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-y-3 md:gap-y-0 w-full">
                    <div>
                        <h3 className="text-[#040000] text-[24px] lg:text-[32px] font-extrabold w-full lg:w-8/12">Latest Jobs</h3>
                        <p className="text-[#808080] font-normal text-sm md:w-8/12">We currently support Facebook, Instagram, LinkedIn and Twitter. More to come. Felix is purpose built for ease of use and complete flexability.</p>
                    </div>
                    <Button variant="outline" size="md" className="!text-[#2F2F2F] !text-[12.5px] !md:text-sm px-4 py-4 !border !border-[#DCDCDC] !w-[205px]">See More News</Button>
                </div>
